<template>
  ...
  >
    ...
    <el-table-column prop="tianshu" label="总出勤天数" width="180"> </el-table-column>
    <el-table-column prop="jiaban" label="加班天数" width="180"> </el-table-column>
    <el-table-column prop="jxbl" label="绩效比例" width="180">
    </el-table-column>
    <el-table-column prop="bufa" label="补发上月" width="180">
    </el-table-column>
    <el-table-column prop="canbu" label="餐补（天）" width="180">
    </el-table-column>
    <el-table-column prop="kcsy" label="扣除上月" width="180">
    </el-table-column>
    <el-table-column prop="queka" label="缺卡(次)" width="180">
    </el-table-column>
    <el-table-column prop="kuangg" label="旷工(次)" width="180">
    </el-table-column>
    <el-table-column prop="shijia" label="事假(次)" width="180">
    </el-table-column>
    <el-table-column prop="bingjia" label="病假(次)" width="180">
    </el-table-column>
    <el-table-column prop="nianjia" label="年假(天)" width="180">
    </el-table-column>
    <el-table-column prop="chanjia" label="产假(天)" width="180">
    </el-table-column>
    <el-table-column prop="cdzt" label="迟到早退的次数" width="180">
    </el-table-column>
